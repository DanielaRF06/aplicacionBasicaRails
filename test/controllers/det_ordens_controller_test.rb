...
class DetOrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create det_orden" do
    assert_difference('DetOrden.count') do
      post det_ordens_url, params: { det_orden: { cantidad: @det_orden.cantidad, id_prod: @det_orden.id_prod, precio: @det_orden.precio } }
    end
  ...
  test "should update det_orden" do
    patch det_orden_url(@det_orden), params: { det_orden: { cantidad: @det_orden.cantidad, id_prod: @det_orden.id_prod, precio: @det_orden.precio } }
