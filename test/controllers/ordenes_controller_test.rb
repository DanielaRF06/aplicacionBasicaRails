...
class OrdenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordene" do
    assert_difference('Ordene.count') do
      post ordenes_url, params: { ordene: { fecha: @ordene.fecha, id_c: @ordene.id_c, nOrden: @ordene.nOrden } }
    end
  ...
  test "should update ordene" do
    patch ordene_url(@ordene), params: { ordene: { fecha: @ordene.fecha, id_c: @ordene.id_c, nOrden: @ordene.nOrden } }
